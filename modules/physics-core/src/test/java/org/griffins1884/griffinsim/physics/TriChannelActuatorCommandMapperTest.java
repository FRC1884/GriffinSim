...
class TriChannelActuatorCommandMapperTest {
  @Test
  void mapsPlanarAndHeadingChannels() {
    TriChannelActuatorCommandMapper mapper =
        new TriChannelActuatorCommandMapper("robot", 0, 1, 2, 50.0, 10.0, 100.0, 20.0);
    ActuatorFrame frame =
        new ActuatorFrame(
            FrameHeader.current(20_000_000L, 1),
            List.of(new PwmOutput(0, 0.5), new PwmOutput(1, -0.25), new PwmOutput(2, 0.4)));
    ...
    assertEquals(8.0, command.torqueZ(), 1e-9);
  }
}
